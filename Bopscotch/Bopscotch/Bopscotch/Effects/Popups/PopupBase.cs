...
namespace Bopscotch.Effects.Popups
{
    public abstract class PopupBase : ISimpleRenderable, IAnimated, ITransformationAnimatable, IColourAnimatable, ISerializable, ITextureManaged
    {
        ...
        public string TextureReference { get { return _textureReference; } set { InitializeForNamedTexture(value); } }
        public Texture2D Texture { get; set; }
        public Rectangle Frame { get; set; }
        public Vector2 Origin { private get; set; }
        public Vector2 DisplayPosition { protected get; set; }
        ...
        private void InitializeForNamedTexture(string textureName)
        {
            if (!string.IsNullOrEmpty(textureName))
            {
                _textureReference = textureName;
        ...
        {
            spriteBatch.Draw(Texture, DisplayPosition, Frame, Tint, Rotation, Origin, Scale, SpriteEffects.None, RenderDepth);
        }
