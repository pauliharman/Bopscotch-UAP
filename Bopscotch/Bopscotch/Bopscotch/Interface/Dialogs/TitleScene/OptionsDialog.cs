...
namespace Bopscotch.Interface.Dialogs.TitleScene
{
    public class OptionsDialog : ButtonDialog
    {
            ...
            : base()
        {
            ...
            AddButton("Back", new Vector2(Definitions.Left_Button_Column_X, 400.0f), Button.ButtonIcon.B, Color.Red, 0.7f);
        ...
        {
            if ((buttonCaption == "Back") || (buttonCaption == "Reset Game")) { Dismiss(); }
