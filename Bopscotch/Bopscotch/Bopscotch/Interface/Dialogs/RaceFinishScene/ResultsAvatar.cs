...
namespace Bopscotch.Interface.Dialogs.RaceFinishScene
{
    public class ResultsAvatar : DialogAvatar
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(TextureManager.Textures[Podium_Texture_Name], _baseWorldPosition + new Vector2(0.0f, Podium_Y_Offset_From_Center), null,
                Color.White, 0.0f, new Vector2(TextureManager.Textures[Podium_Texture_Name].Width / 2.0f, 0.0f), 1.0f, SpriteEffects.None, 
                Podium_Render_Depth);
        }
