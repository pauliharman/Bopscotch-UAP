...
namespace Bopscotch.Interface.Dialogs
{
    public class ButtonDialog : ISimpleRenderable, IMobile
    {
        ...
        public int RecoilMultiplier { set { _entryMotionEngine.RecoilMultiplier = value; _exitMotionEngine.RecoilMultiplier = value; } }
        ...
        public InputProcessorBase ActuatingController { get; private set; }
        ...
        public virtual void Reset()
        {
            ...
            if ((!string.IsNullOrEmpty(_defaultButtonCaption)) && ((string.IsNullOrEmpty(_activeButtonCaption)) || (_activeButtonCaption == "Back")))
            { 
        ...
        private void CheckForAndHandleInput(int millisecondsSinceLastUpdate)
        {
            ...
            { 
                ...
                if (ActuatingController != null) { break; }
            }
        }
        ...
        protected const int Default_Recoil_Multiplier = 5;
