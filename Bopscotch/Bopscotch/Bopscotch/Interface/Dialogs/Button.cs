...
namespace Bopscotch.Interface.Dialogs
{
    public class Button
    {
        ...
        public string Caption { set { _caption = value; _translatedCaption = ""; } }
        ...
        public virtual void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (_iconIndex > -1)
            {
                spriteBatch.Draw(TextureManager.Textures[Icon_Texture], ParentPosition + _iconPosition, IconFrame(_iconIndex), Color.Black, 0.0f,
