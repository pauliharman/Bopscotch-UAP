...
namespace Bopscotch.Gameplay.Objects.Display.Survival
{
    public class TutorialRunner : ISimpleRenderable, ISerializable
    {
        ...
        {
            spriteBatch.Draw(TextureManager.Textures[Prompt_Icon_Texture_Name],
                new Vector2(Text_Minimum_Left, Title_Maximum_Top), _promptFrame,
                Color.White, 0.0f, Vector2.Zero, 1.75f, SpriteEffects.None, 0.01f);
        }
