...
namespace Bopscotch.Gameplay.Objects.Display.Race
{
    public class PowerUpHelper : ISimpleRenderable, ISerializable, IMobile
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(
                TextureManager.Textures[X_Button_Texture],
                WorldPosition + new Vector2(-((TextWriter.LastTextArea.Width / 2) + Icon_X_Offset), Icon_Y_Offset),
                null,
                Color.White,
                0.0f,
                Vector2.Zero,
        ...
        private const string X_Button_Texture = "icon-x-button";
        private const float Icon_X_Offset = 80.0f;
        private const float Icon_Y_Offset = 10.0f;
    }
}
