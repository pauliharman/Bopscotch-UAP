...
namespace Bopscotch.Gameplay.Objects.Display.Race
{
    public class PowerUpTimer : ISimpleRenderable, IMobile
    {
        ...
        {
            spriteBatch.Draw(TextureManager.Textures[Base_Texture_Name], DisplayTopRight + WorldPosition, null, Color.White, 0.0f,
                _textureOrigin, 1.0f, SpriteEffects.None, Base_Render_Depth);

            spriteBatch.Draw(_iconTexture, DisplayTopRight + WorldPosition, null, Color.White, 0.0f,
                new Vector2(_iconTexture.Width, _iconTexture.Height) / 2.0f, 1.0f, SpriteEffects.None, Icon_Render_Depth);

            spriteBatch.Draw(TextureManager.Textures[Needle_Texture_Name], DisplayTopRight + WorldPosition, null, Color.White,
                (MathHelper.TwoPi * _durationTimer.CurrentActionProgress), _textureOrigin, 1.0f, SpriteEffects.None, Needle_Render_Depth);
        }
