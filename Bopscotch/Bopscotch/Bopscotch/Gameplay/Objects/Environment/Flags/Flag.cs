...
namespace Bopscotch.Gameplay.Objects.Environment.Flags
{
    public abstract class Flag : StorableSimpleDrawableObject, IBoxCollidable, ICameraRelative, IAnimated
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(TextureManager.Textures[Pole_Texture], _poleWorldPosition - CameraPosition, null, Color.White, 0.0f, Vector2.Zero, 1.0f,
                SpriteEffects.None, Pole_Render_Depth);
        }
