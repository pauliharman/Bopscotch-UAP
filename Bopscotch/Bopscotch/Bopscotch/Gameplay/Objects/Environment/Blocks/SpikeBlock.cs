...
namespace Bopscotch.Gameplay.Objects.Environment.Blocks
{
    public class SpikeBlock : ObstructionBlock, IAnimated
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(TextureManager.Textures[Outer_Texture_Name], WorldPosition - CameraPosition, null, Color.White, 0.0f,
                new Vector2(Definitions.Grid_Cell_Pixel_Size) / 2.0f, 1.0f, SpriteEffects.None, RenderDepth + Outer_Render_Depth_Offset);
        }
